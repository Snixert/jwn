...
parser.add_argument('-hf', action='store', dest='hour_format', default='24',
                        help='12 hour or 24 hour format.')

parser.add_argument('-df', action='store', dest='digit_format', default='6',
                        help='3-digit format or 6-digit format.')
