...
parser.add_argument('-f', action='store', dest='hour_format', default='24', help='12 hour or 24 hour format.')

parser.add_argument('-d', action='store', dest='digit_format', default='6', help='3-digit format or 6-digit format.')
...
if args.digit_format == "3":
    print("hehe")
    is3digitFormat == True
    print("boolean value: " + is3digitFormat)

def signalHandler(signalNumber, frame):
            '''Shows a message before ending the program'''
            hat.show_message("Programmet slutter", 0.001)
            sys.exit(1)
...
while True:
    ...
    if welcome:
        hat.show_message("Programmet starter", 0.001)
        welcome = False
